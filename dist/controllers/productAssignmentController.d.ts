...
export declare function getAssignmentHistory(_req: Request, res: Response): Promise<void>;
...
export declare function bulkAssignProducts(req: Request, res: Response): Promise<void>;
