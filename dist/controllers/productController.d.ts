...
export declare function getAssignedProducts(req: Request, res: Response): Promise<void>;
...
export declare const generateProductQr: (req: Request, res: Response) => Promise<void>;
